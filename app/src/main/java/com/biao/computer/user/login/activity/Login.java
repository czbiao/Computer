...
import com.biao.computer.user.login.global.GlobalConstants;
...
public class Login extends Activity {
    ...
    private TextView login_back = null;
    ...
    private void init() {
        ...
        login_back = (TextView) this.findViewById(R.id.login_back);
    }
    ...
    private void initListener() {
        ...
        this.login_back.setOnClickListener(new TextViewBack());
     ...
     * 设置返回
     */
    private class TextViewBack implements OnClickListener {
        @Override
        public void onClick(View arg0) {
            // TODO Auto-generated method stub
            // 暂时无响应事件
