...
import com.biao.computer.commun.circledemo.activity.*;
import com.biao.computer.commun.circledemo.activity.MainActivity;
import com.biao.computer.commun.circledemo.adapter.CircleAdapter;
import com.biao.computer.commun.circledemo.bean.CircleItem;
import com.biao.computer.commun.circledemo.bean.CommentConfig;
...
import com.biao.computer.commun.circledemo.mvp.contract.CircleContract;
import com.biao.computer.commun.circledemo.mvp.presenter.CirclePresenter;
import com.biao.computer.commun.circledemo.utils.CommonUtils;
import com.biao.computer.commun.circledemo.utils.DatasUtil;
import com.biao.computer.commun.circledemo.widgets.CommentListView;
import com.biao.computer.commun.circledemo.widgets.DivItemDecoration;
import com.biao.computer.commun.circledemo.widgets.dialog.UpLoadDialog;
...
import static com.biao.computer.commun.circledemo.utils.DatasUtil.HEADIMG;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.createCommentItemList;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.createFavortItemList;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.circleId;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.curUser;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.getContent;
import static com.biao.computer.commun.circledemo.utils.DatasUtil.users;
...
public class CommunFragment extends Fragment implements CircleContract.View, EasyPermissions.PermissionCallbacks {
    ...
    protected static final String TAG = com.biao.computer.commun.circledemo.activity.MainActivity.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        publishbtn = (TextView) view_i.findViewById(R.id.publishbtn);
        ...
        recyclerView.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if(newState == RecyclerView.SCROLL_STATE_IDLE){
                    Glide.with(com.biao.computer.commun.CommunFragment.this).resumeRequests();
                }else{
                    Glide.with(com.biao.computer.commun.CommunFragment.this).pauseRequests();
                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 0 && resultCode == Activity.RESULT_OK) {
            ...
            //User user = new User("88", "这真的是我自己", HEADIMG[0]);
            //users.add(user);
            CircleItem item = new CircleItem();
            item.setId(String.valueOf(circleId++));
            item.setUser(curUser);
            item.setContent(str);
            item.setCreateTime("刚刚");
            item.setType("2");// 链接
            ...
            //String videoImgUrl = "http://img3.imgtn.bdimg.com/it/u=659401488,1954335603&fm=23&gp=0.jpg";
            ...
            //将动态刷新到列表中
            circleAdapter.getDatas().add(0, item);
            circleAdapter.notifyDataSetChanged();
        }
    }
