...
public class DatasUtil {
	public static final String[] CONTENTS = { "",
			"哈哈，18123456789,ChinaAr  http://www.ChinaAr.com;一个不错的VR网站。",
			"今天是个好日子",
	...
	public static final String[] HEADIMG = {
			"http://139.199.171.66:8080/download/hanshi.jpg",
	...
	static {
		...
		User user6 = new User("6", "Miao", HEADIMG[6]);
		User user7 = new User("7", "这个名字是不是很长哈哈", HEADIMG[7]);
	...
	public static List<CircleItem> createCircleDatas() {
		...
		for (int i = 0; i < 15; i++) {
			...
			if (type == 0) {
                ...
                String videoImgUrl = "http://139.199.171.66:8080/download/miaopai.jpg";
	...
	public static CommentItem createComment() {
		...
		String comment[] = {"是呀","没错","你好自恋","哈哈,我是一个评论","这个图不错","哇好美好帅","我喜欢你","你不乖了","我也是这么觉得的","你说得对","对呀就是这样",
				"怎么这么机智","今天确实不错","哎呀日常表白你","每天幸福哦","在这都有你","爸爸是爱你的","挺好的我觉得"};
