package com.biao.computer.mould;
...
//		Log.e("eee", Environment.getExternalStorageDirectory().getPath()+ File.separator+"a1.jpg");
        ...
        //res图片资源
        list.add(new Mould_ImageCycleView.ImageInfo(R.drawable.mould1,"美体塑形减肥方法 腿部按摩手法视频","第一张"));
        list.add(new Mould_ImageCycleView.ImageInfo(R.drawable.mould2,"十分钟减肥塑形健身操","第二张"));
        list.add(new Mould_ImageCycleView.ImageInfo(R.drawable.mould3,"全面瘦身塑形-初阶3 迷你练习","第三张"));
        list.add(new Mould_ImageCycleView.ImageInfo(R.drawable.mould2,"减肥塑形健身操","第四张"));
